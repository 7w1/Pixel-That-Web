# Made by Rasmus - https://godotengine.org/qa/9947/responsive-to-fit-multiple-resolutions

extends Node

onready var viewport = get_viewport()

var minimum_size = Vector2(1440, 810) # Set this to your games default resolution
